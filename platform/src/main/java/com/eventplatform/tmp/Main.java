...
/*
        ...
        DataService cu = DataControllerAggregator.getInstance().getByType(DataServiceConstants.USER_TYPE);
        ...
        DataService<Maintainer> mu = DataControllerAggregator.getInstance().getByType(DataServiceConstants.MAINTAINER_TYPE);
